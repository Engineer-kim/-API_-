...
public class MovieInfoController {
    ...
    public ResponseEntity<List<MovieInfoResponseDto>> getMovieList(@RequestParam MovieRequestInfoDto movieRequestInfoDto) {
    ...
    public ResponseEntity<List<MovieInfoResponseDto>> showDailyMovieRank(@RequestParam MovieRequestInfoDto movieRequestInfoDto) {
        //List<MovieInfoResponseDto> movieListMono = movieInfoService.getAllMovieList(movieRequestInfoDto);
        System.out.println(movieListMono);
        //return new ResponseEntity<>(movieListMono, HttpStatus.OK);
    }
